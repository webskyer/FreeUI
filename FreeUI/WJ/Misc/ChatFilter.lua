...
cf.Config = {
	...
	["nojoinleaveChannel"] = nil, --Disable the alert joinleaveChannel. // 关闭进出频道提示

	["MergeTalentSpec"] = nil, --Merge the messages:"You have learned/unlearned..." // 当切换天赋后合并显示“你学会了/忘却了法术…”
	["FilterPetTalentSpec"] = nil, --Filter the messages:"Your pet has learned/unlearned..." // 不显示“你的宠物学会了/忘却了…”

	["MergeAchievement"] = nil, --Merge the messages:"...has earned the achievement..." // 合并显示获得成就
	...
	["FilterDrunkMSG"] = nil, --Filter the drunk messages:"... has drunked ..."// 过滤“...喝醉了.”
	...
	["OnlyOnWhisper"] = true, --Only filter the whisper messages. // 只过滤密语
